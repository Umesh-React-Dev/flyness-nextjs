    ...
    <div className="english template-home stickyWidget">
      <div className="page">
        <header className="section page-header ">
          <div
            className="rd-navbar-wrap rd-navbar-corporate"
            style={{ height: "95.5px" }}
          >
            <nav
              className="rd-navbar rd-navbar-original rd-navbar-static rd-navbar--is-stuck"
            ...
            >
              ...
              <div className="rd-navbar-inner">
                  ...
                  <div className="rd-navbar-brand">
                    <a className="brand-name" href="https://www.flynas.com/en">
                      <img
                        ...
                        src="./refresh-icon_files/flynas-logo-green.svg"
                        alt=""
                        width="163"
                        height="46"
                      />
                      <img
                        ...
                        src="./refresh-icon_files/flynas-logo.svg"
                        alt=""
                        width="163"
                        height="55"
                        loading="lazy"
                ...
                <div className="rd-navbar-aside-center"></div>
                <div className="rd-navbar-aside-right">
                  <div className="nav-bar-aside-top-menu align-items-center">
                    <div className="rd-navbar-aside-right-inner-search text-right d-flex align-items-center">
                      <div className="rd-navbar-search toggle-original-elements">
                        <a
                          className="rd-navbar-search-toggle border-0 mt-0 toggle-original"
                          data-rd-navbar-toggle=".rd-navbar-search"
                          href="https://www.flynas.com/en#"
                        >
                          <i className="fa fa-search"></i>
                        </a>
                        <form
                          className="rd-search"
                          action="https://www.flynas.com/search"
                          method="GET"
                        >
                          <div className="form-wrap search-form-wrap d-inline-flex">
                            <input
                              ...
                              placeholder="Search..."
                            />
                            <button className="rd-search-form-submit mdi mdi-magnify">
                      ...
                      <div className="d-none d-lg-flex align-items-center">
                        ...
                        >
                          <div className="logged-out-view d-flex align-items-center">
                            <a
                              href="https://booking.flynas.com/#/member/login-redirect?culture=en-US"
                              className="login-btn-new"
                            >
                              <span className="d-flex">Log In</span>
                            </a>
                          ...
                          <div className="logged-in-view d-none justify-content-between">
                            ...
                            <div className="user-actions">
                              <a
                                href="https://booking.flynas.com/#/member/login-redirect?logout&amp;redirectUrl=https://booking.flynas.com"
                          ...
                          <a
                            className="help-support-section d-flex align-items-center"
                      ...
                      <div className="d-lg-none d-block px-2">
                        ...
                        >
                          ...
                          <div className="logged-in-view d-none w-100 justify-content-between">
                            ...
                            <div
                              id="userMenu"
                              className="card shadow position-absolute end-0 p-3"
                              style={{ display: "none" }}
                            >
                    ...
                    <div className="language-dropdown">
                      <button
                        type="button"
                        className="btn btn-top-header dropdown-toggle"
                      ...
                      <form className="dropdown-menu dropdown-menu-end p-4">
                        <div className="mb-3">
                          ...
                          <label
                            htmlFor=""
                            className="form-label d-block text-bold"
                          >
                            KSA (English)
                          </label>
                          <hr />
                        ...
                        <div className="mb-3">
                          ...
                          <div className="mb-3">
                            ...
                            <a
                              href="https://www.flynas.com/en/home"
                              className="me-2"
                            >
                              English{" "}
                            </a>
                            <a
                              href="https://www.flynas.com/ar/home"
                              className="me-2"
                            >
                              عربي{" "}
                            </a>
                          ...
                          <div className="mb-3">
                            ...
                            <a
                              href="https://www.flynas.com/en-eu/home"
                              className="me-2"
                            >
                              English
                            </a>
                          ...
                          <div className="mb-3">
                            ...
                            <a
                              href="https://www.flynas.com/ru-ru/home"
                              className="me-2"
                            >
                              Russian
                            </a>
                          ...
                          <div className="mb-3">
                            ...
                            <a
                              href="https://www.flynas.com/en-bh/home"
                              className="me-2"
                            >
                              English
                            </a>
                            <a
                              href="https://www.flynas.com/ar-bh/home"
                              className="me-2"
                            >
                              عربي{" "}
                            </a>
                          ...
                          <div className="mb-3">
                            ...
                            <a
                              href="https://www.flynas.com/en-ae/home"
                              className="me-2"
                            >
                              English
                            </a>
                            <a
                              href="https://www.flynas.com/ar-ae/home"
                              className="me-2"
                            >
                              عربي{" "}
                            </a>
                          ...
                          <div className="mb-3">
                            ...
                            <a
                              href="https://www.flynas.com/en-kw/home"
                              className="me-2"
                            >
                              English
                            </a>
                            <a
                              href="https://www.flynas.com/ar-kw/home"
                              className="me-2"
                            >
                              عربي{" "}
                            </a>
                          ...
                          <div className="mb-3">
                            ...
                            <a
                              href="https://www.flynas.com/en-sy/home"
                              className="me-2"
                            >
                              English
                            </a>
                            <a
                              href="https://www.flynas.com/ar-sy/home"
                              className="me-2"
                            >
                              عربي{" "}
                            </a>
                  ...
                  <div className="rd-navbar-nav-wrap d-flex justify-content-end toggle-original-elements">
                    <div className="btn-close-menu mobile-only">
                      <a id="btnCloseMainMenu">
                        <i className="fa-solid fa-xmark"></i>
                      </a>
                    </div>
                    <ul className="rd-navbar-nav">
                      <li className="rd-nav-item has-megamenu rd-navbar--has-megamenu rd-navbar-submenu">
                        <a href="https://www.flynas.com/en#">Plan and book</a>
                          ...
                          <div className="rd-navbar-megamenu-tabs-content">
                            <div className="row g-0 align-items-stretch d-none d-lg-flex">
                              <div className="col-md-3 mb-4 mb-lg-0 d-flex">
                                <div
                                  className="nav flex-column nav-pills left-tabs"
                                  role="tablist"
                                >
                                  <button
                                    className="nav-link  active"
                                    data-bs-toggle="pill"
                                    data-bs-target="#tab-0-0"
                                    aria-selected="true"
                                    role="tab"
                                  >
                                    <i
                                      style={{
                                        backgroundPosition: "-49px -39px",
                                      }}
                                    ></i>
                                    <div>
                                      <h6>Plan your journey</h6>
                                      <p>
                                        Explore travel options, fares, and
                                        offers
                                      </p>
                                    </div>
                                  </button>
                                  ...
                                  >
                                    <i
                                      style={{
                                        backgroundPosition: "-49px -101.5px",
                                      }}
                                    ></i>
                                    <div>
                                  ...
                                  >
                                    <div className="row g-0">
                                      ...
                                      >
                                        <i
                                          style={{
                                            backgroundPosition: "-321px -41px",
                                          }}
                                        ></i>
                                        <div>
                                          <h6>Summer Destinations</h6>
                                          <p>
                                            Top seasonal offers and places to go
                                          </p>
                                        </div>
                                      </a>
                                      <a
                                      ...
                                      >
                                        <i
                                          style={{
                                            backgroundPosition: "-113px -159px",
                                          }}
                                        ></i>
                                        <div>
                                          <h6>Flights</h6>
                                          <p>
                                            Search and book available routes
                                          </p>
                                        </div>
                                      </a>
                                      <a
                                      ...
                                      >
                                        ...
                                        <div>
                                          <h6>Fare types</h6>
                                          <p>
                                            Compare bundles to suit your needs
                                          </p>
                                        </div>
                                      </a>
                                      <a
                                      ...
                                      >
                                        ...
                                        <div>
                                          ...
                                          <p>
                                            Find the cheapest flights easily
                                          </p>
                                        </div>
                                      </a>
                                      <a
                                      ...
                                      >
                                        <i
                                          style={{
                                            backgroundPosition: "-83px -100px",
                                          }}
                                        ></i>
                                        <div>
                                          <h6>Price lock</h6>
                                          <p>
                                            Secure your fare before confirming
                                          </p>
                                        </div>
                                      </a>
                                      <a
                                      ...
                                      >
                                        <i
                                          style={{
                                            backgroundPosition: "-117px -196px",
                                          }}
                                        ></i>
                                        <div>
                                      ...
                                      >
                                        <i
                                          style={{
                                            backgroundPosition: "-287px -131px",
                                          }}
                                        ></i>
                                        <div>
                                  ...
                                  >
                                    <div className="row g-0">
                                      ...
                                      >
                                        <i
                                          style={{
                                            backgroundPosition: "-321px -105px",
                                          }}
                                        ></i>
                                        <div>
                                          <h6>nasholidays</h6>
                                          <p>
                                            All-in-one packages and getaways
                                          </p>
                                        </div>
                                      </a>
                                      <a
                                      ...
                                      >
                                        <i
                                          style={{
                                            backgroundPosition: "-220px -165px",
                                          }}
                                        ></i>
                                        <div>
                                          <h6>Travel Ideas</h6>
                                          <p>
                                            Inspiration and themed travel tips
                                          </p>
                                        </div>
                                      </a>
                                      <a
                                      ...
                                      >
                                        <i
                                          style={{
                                            backgroundPosition: "-253px -8px",
                                          }}
                                        ></i>
                                        <div>
                                          <h6>Hotels</h6>
                                          <p>
                                            Book stays with flexible options
                                          </p>
                                        </div>
                                      </a>
                                      <a
                                      ...
                                      >
                                        <i
                                          style={{
                                            backgroundPosition: "-151px -102px",
                                          }}
                                        ></i>
                                        <div>
                                          <h6>Rent a car</h6>
                                          <p>
                                            Convenient rentals for your trip
                                          </p>
                                        </div>
                                      </a>
                                      <a
                                      ...
                                      >
                                        <i
                                          style={{
                                            backgroundPosition: "-83px -163px",
                                          }}
                                        ></i>
                                        <div>
                                          <h6>Cargo</h6>
                                          <p>
                                            Send or receive shipments easily
                                          </p>
                                        </div>
                                      </a>
                                      <a
                                  ...
                                  >
                                    <div className="row g-0">
                                      ...
                                      >
                                        <i
                                          style={{
                                            backgroundPosition: "-287px -162px",
                                          }}
                                        ></i>
                                        <div>
                                      ...
                                      >
                                        <i
                                          style={{
                                            backgroundPosition: "-321px -101px",
                                          }}
                                        ></i>
                                        <div>
                                          <h6>eVisa</h6>
                                      ...
                                      >
                                        <i
                                          style={{
                                            backgroundPosition: "-321px -70px",
                                          }}
                                        ></i>
                                        <div>
                                          <h6>Stopover Visa</h6>
                                          <p>
                                            Transit visa details for connections
                                          </p>
                                        </div>
                                      </a>
                                      <a
                                      ...
                                      >
                                        <i
                                          style={{
                                            backgroundPosition: "-151px -43px",
                                          }}
                                        ></i>
                                        <div>
                                          <h6>Required vaccines</h6>
                                          <p>
                                            Health rules for travel readiness
                                          </p>
                                        </div>
                                      </a>
                                    </div>
                            ...
                            <div
                              className="accordion accordion-flush d-lg-none"
                                ...
                                <div className="accordion-body p-0">
                                  <div className="accordion accordion-flush ms-2">
                                    <div className="accordion-item">
                                      ...
                                      <div
                                        id="acc-child-0-187d25be-6e96-4840-92a3-cf4c93a17e2f"
                                  ...
                                  <div className="accordion accordion-flush ms-2">
                                    <div className="accordion-item">
                                      ...
                                      <div
                                        id="acc-child-0-8eeb3eb8-a43e-498b-9942-819d1af13204"
                                        className="accordion-collapse collapse"
                                      >
                                        <div className="accordion-body p-0">
                                          <a
                                  ...
                                  <div className="accordion accordion-flush ms-2">
                                    <div className="accordion-item">
                                      ...
                                      <div
                                        id="acc-child-0-2da9648c-bcbd-4ee6-a208-4a7497ef9d33"
                                        className="accordion-collapse collapse"
                                      >
                                        <div className="accordion-body p-0">
                                          <a
                                ...
                                >
                                  ...
                                  >
                                    ...
                                    <div>
                                      <h6>Baggage</h6>
                                      <p>
                                        Carry-on, checked, and special items
                                      </p>
                                    </div>
                                  </button>
                                  <button
                                  ...
                                  >
                                    ...
                                    <div>
                                      ...
                                      <p>
                                        Edit your trip, add extras, or check in
                                      </p>
                                    </div>
                                  </button>
                                  <button
                                  ...
                                  >
                                    <i
                                      style={{
                                        backgroundPosition: "-287px -39px",
                                      }}
                                    ></i>
                                    <div>
                                      <h6>Enhance your trip</h6>
                                      <p>
                                        Upgrade and personalize your journey
                                      </p>
                                    </div>
                                  </button>
                                </div>
                                  ...
                                  >
                                    <div className="row g-0">
                                      ...
                                      >
                                        <i
                                          style={{
                                            backgroundPosition: "-249px -66px",
                                          }}
                                        ></i>
                                        <div>
                                          <h6>Sports equipment</h6>
                                          <p>
                                            Bringing golf bags, skis, and more
                                          </p>
                                        </div>
                                      </a>
                                      <a
                                      ...
                                      >
                                        ...
                                        <div>
                                          ...
                                          <p>
                                            Traveling with fragile or oversized
                                            items
                                          </p>
                                        </div>
                                      </a>
                                      ...
                                      >
                                        <i
                                          style={{
                                            backgroundPosition: "-151px -133px",
                                          }}
                                        ></i>
                                        <div>
                                          <h6>
                                  ...
                                  >
                                    <div className="row g-0">
                                      ...
                                      >
                                        <i
                                          style={{
                                            backgroundPosition: "-15px -194px",
                                          }}
                                        ></i>
                                        <div>
                                          <h6>Change your booking</h6>
                                          <p>
                                            Modify flight or passenger details
                                          </p>
                                        </div>
                                      </a>
                                      <a
                                      ...
                                      >
                                        <i
                                          style={{
                                            backgroundPosition: "-287px -101px",
                                          }}
                                        ></i>
                                        <div>
                                          <h6>Add services</h6>
                                          <p>
                                            Include extras like meals or seats
                                          </p>
                                        </div>
                                      </a>
                                      <a
                                      ...
                                      >
                                        ...
                                        <div>
                                          ...
                                          <p>
                                            Check in before arriving at the
                                            airport
                                          </p>
                                        </div>
                                      </a>
                                      ...
                                      >
                                        <i
                                          style={{
                                            backgroundPosition: "-219px -10px",
                                          }}
                                        ></i>
                                        <div>
                                          <h6>Fly Ahead</h6>
                                          <p>
                                            Switch to an earlier flight if
                                            available
                                          </p>
                                        </div>
                                      </a>
                                    ...
                                    <div className="row g-0">
                                      ...
                                      >
                                        ...
                                        <div>
                                          ...
                                          <p>
                                            Select your preferred seat location
                                          </p>
                                        </div>
                                      </a>
                                      <a
                                      ...
                                      >
                                        <i
                                          style={{
                                            backgroundPosition: "-253px -101px",
                                          }}
                                        ></i>
                                        <div>
                                          <h6>Priority Service</h6>
                                          <p>
                                            Faster check-in and early boarding
                                          </p>
                                        </div>
                                      </a>
                                      <a
                                      ...
                                      >
                                        <i
                                          style={{
                                            backgroundPosition: "-83px -70px",
                                          }}
                                        ></i>
                                        <div>
                                          <h6>Upgrade to premium</h6>
                                          <p>
                                            Extra comfort, flexibility &amp;
                                            perks
                                          </p>
                                        </div>
                                      </a>
                                      ...
                                      >
                                        <i
                                          style={{
                                            backgroundPosition: "-49px 138.5px",
                                          }}
                                        ></i>
                                        <div>
                                          <h6>Buy lounge access</h6>
                                          <p>
                                            Relax before your flight in style
                                          </p>
                                        </div>
                                      </a>
                                      <a
                                      ...
                                      >
                                        <i
                                          style={{
                                            backgroundPosition: "-151px -69px",
                                          }}
                                        ></i>
                                        <div>
                                          <h6>Order your visa</h6>
                                          <p>
                                            Visa support for your destination
                                          </p>
                                        </div>
                                      </a>
                                      <a
                                ...
                                <div className="accordion-body p-0">
                                  <div className="accordion accordion-flush ms-2">
                                    <div className="accordion-item">
                                      ...
                                      <div
                                        id="acc-child-1-ae14b3c3-466a-486a-b29d-7a33be398d71"
                                        className="accordion-collapse collapse"
                                      >
                                        <div className="accordion-body p-0">
                                          <a
                                  ...
                                  <div className="accordion accordion-flush ms-2">
                                    <div className="accordion-item">
                                      ...
                                      <div
                                        id="acc-child-1-c21abfe1-0027-46cf-9446-450876eedf35"
                                        className="accordion-collapse collapse"
                                      >
                                        <div className="accordion-body p-0">
                                          <a
                                  ...
                                  <div className="accordion accordion-flush ms-2">
                                    <div className="accordion-item">
                                      ...
                                      <div
                                        id="acc-child-1-ed750896-4957-4b79-9d81-41ef6474078a"
                                        className="accordion-collapse collapse"
                                      >
                                        <div className="accordion-body p-0">
                                          <a
                      ...
                      <li className="rd-nav-item has-megamenu rd-navbar--has-megamenu rd-navbar-submenu">
                        <a href="https://www.flynas.com/en#">Information</a>
                        <span className="rd-navbar-submenu-toggle"></span>
                              ...
                              <div className="col-md-3 mb-4 mb-lg-0 d-flex">
                                ...
                                >
                                  <button
                                    className="nav-link  active"
                                    data-bs-toggle="pill"
                                    data-bs-target="#tab-2-0"
                                    aria-selected="true"
                                    role="tab"
                                  >
                                    <i
                                      style={{
                                        backgroundPosition: "-16px -68.5px",
                                      }}
                                    ></i>
                                    <div>
                                      <h6>About flynas</h6>
                                  ...
                                  >
                                    <i
                                      style={{
                                        backgroundPosition: "-49px -71px",
                                      }}
                                    ></i>
                                    <div>
                                      <h6>Special Care</h6>
                                      <p>
                                        Support for families and special needs
                                      </p>
                                    </div>
                                  </button>
                                  <button
                                  ...
                                  >
                                    <div className="row g-0">
                                      ...
                                      >
                                        <i
                                          style={{
                                            backgroundPosition: "-151px -8px",
                                          }}
                                        ></i>
                                        <div>
                                          <h6>About us</h6>
                                          <p>
                                            Get to know flynas and our values
                                          </p>
                                        </div>
                                      </a>
                                      <a
                                      ...
                                      >
                                        <i
                                          style={{
                                            backgroundPosition: "-287px -195px",
                                          }}
                                        ></i>
                                        <div>
                                          <h6>Our fleet</h6>
                                      ...
                                      >
                                        <i
                                          style={{
                                            backgroundPosition: "-321px -195px",
                                          }}
                                        ></i>
                                        <div>
                                      ...
                                      >
                                        ...
                                        <div>
                                          <h6>Our offices</h6>
                                          <p>
                                            Find our locations and contact
                                            details
                                          </p>
                                        </div>
                                      </a>
                                      ...
                                      >
                                        <i
                                          style={{
                                            backgroundPosition: "-287px -69px",
                                          }}
                                        ></i>
                                        <div>
                                          <h6>Investor Relations</h6>
                                          <p>
                                            Explore the latest reports and
                                            financial updates
                                          </p>
                                        </div>
                                      </a>
                                      ...
                                      >
                                        <i
                                          style={{
                                            backgroundPosition: "-15px -135px",
                                          }}
                                        ></i>
                                        <div>
                                          <h6>Al Hilal Partnership</h6>
                                          <p>
                                            Exclusive deals for fans and members
                                          </p>
                                        </div>
                                      </a>
                                      <a
                                      ...
                                      >
                                        <i
                                          style={{
                                            backgroundPosition: "-115px -223px",
                                          }}
                                        ></i>
                                        <div>
                                          <h6>Data Rights requests</h6>
                                          <p>
                                            Allow any customer to submit
                                  ...
                                  >
                                    <div className="row g-0">
                                      ...
                                      >
                                        <i
                                          style={{
                                            backgroundPosition: "-117px -39px",
                                          }}
                                        ></i>
                                        <div>
                                          <h6>Special assistance</h6>
                                          <p>
                                            Help for travelers with limited
                                            mobility
                                          </p>
                                        </div>
                                      </a>
                                      ...
                                      >
                                        <i
                                          style={{
                                            backgroundPosition: "-113px -66px",
                                          }}
                                        ></i>
                                        <div>
                                          <h6>Traveling with children</h6>
                                          <p>
                                            Guidance for parents flying with
                                            kids
                                          </p>
                                        </div>
                                      </a>
                                      ...
                                      >
                                        <i
                                          style={{
                                            backgroundPosition: "-253px -34px",
                                          }}
                                        ></i>
                                        <div>
                                          <h6>Expectant mothers</h6>
                                          <p>
                                            Travel advice and policies during
                                            pregnancy
                                          </p>
                                        </div>
                                      </a>
                                  ...
                                  >
                                    <div className="row g-0">
                                      ...
                                      >
                                        <i
                                          style={{
                                            backgroundPosition: "-185px -165px",
                                          }}
                                        ></i>
                                        <div>
                                          <h6>Premium Class</h6>
                                          <p>
                                            Enjoy more space and exclusive
                                            services
                                          </p>
                                        </div>
                                      </a>
                                      ...
                                      >
                                        <i
                                          style={{
                                            backgroundPosition: "-15px -228px",
                                          }}
                                        ></i>
                                        <div>
                                          <h6>Partnerships</h6>
                                          <p>
                                            Explore our business and travel
                                            partners
                                          </p>
                                        </div>
                                      </a>
                                      ...
                                      >
                                        <i
                                          style={{
                                            backgroundPosition: "-219px -39px",
                                          }}
                                        ></i>
                                        <div>
                                          <h6>Timetable</h6>
                                          <p>
                                            Check flight schedules and
                                            frequencies
                                          </p>
                                        </div>
                                      </a>
                                      ...
                                      >
                                        ...
                                        <div>
                                          <h6>Blog</h6>
                                          <p>
                                            Travel guides, tips, offers, and
                                            destination inspiration from flynas.
                                          </p>
                                        </div>
                                      </a>
                                    </div>
                                ...
                                <div className="accordion-body p-0">
                                  <div className="accordion accordion-flush ms-2">
                                    <div className="accordion-item">
                                      ...
                                      <div
                                        id="acc-child-2-20de684c-eb79-4066-a751-b71795e6bca0"
                                        className="accordion-collapse collapse"
                                      >
                                        <div className="accordion-body p-0">
                                          <a
                                  ...
                                  <div className="accordion accordion-flush ms-2">
                                    <div className="accordion-item">
                                      ...
                                      <div
                                        id="acc-child-2-19206524-76d9-4651-a3a9-4d785131bb4f"
                                        className="accordion-collapse collapse"
                                      >
                                        <div className="accordion-body p-0">
                                          <a
                                  ...
                                  <div className="accordion accordion-flush ms-2">
                                    <div className="accordion-item">
                                      ...
                                      <div
                                        id="acc-child-2-c74a9846-e696-40a8-9c04-4bd53f102210"
                                        className="accordion-collapse collapse"
                                      >
                                        <div className="accordion-body p-0">
                                          <a
                      ...
                      <li className="rd-nav-item has-megamenu rd-navbar--has-megamenu rd-navbar-submenu">
                        <a href="https://www.flynas.com/en#">nasmiles</a>
                        <span className="rd-navbar-submenu-toggle"></span>
                              ...
                              <div className="col-md-3 mb-4 mb-lg-0 d-flex">
                                ...
                                >
                                  <button
                                    className="nav-link  active"
                                    data-bs-toggle="pill"
                                    data-bs-target="#tab-3-0"
                                    aria-selected="true"
                                    role="tab"
                                  >
                                    <i
                                      style={{
                                        backgroundPosition: "-83px -39px",
                                      }}
                                    ></i>
                                    <div>
                                      <h6>Earn nasmiles</h6>
                                  ...
                                  >
                                    <i
                                      style={{
                                        backgroundPosition: "-15px -102.5px",
                                      }}
                                    ></i>
                                    <div>
                                      <h6>Spend nasmiles</h6>
                                      <p>
                                        Use your miles for rewards and perks
                                      </p>
                                    </div>
                                  </button>
                                  <button
                                  ...
                                  >
                                    <i
                                      style={{
                                        backgroundPosition: "-15px -38px",
                                      }}
                                    ></i>
                                    <div>
                                      <h6>Programme</h6>
                                      <p>
                                        Explore membership levels and benefits
                                      </p>
                                    </div>
                                  </button>
                                </div>
                                  ...
                                  >
                                    <div className="row g-0">
                                      ...
                                      >
                                        <i
                                          style={{
                                            backgroundPosition: "-219px -71px",
                                          }}
                                        ></i>
                                        <div>
                                          <h6>All about earning</h6>
                                          <p>
                                            Ways to earn nasmiles on flights and
                                            more
                                          </p>
                                        </div>
                                      </a>
                                      ...
                                      >
                                        <i
                                          style={{
                                            backgroundPosition: "-83px -134px",
                                          }}
                                        ></i>
                                        <div>
                                          <h6>Claim missing nasmiles</h6>
                                          <p>
                                            Submit a request for uncredited
                                            miles
                                          </p>
                                        </div>
                                      </a>
                                      ...
                                      >
                                        <i
                                          style={{
                                            backgroundPosition: "-289px -6px",
                                          }}
                                        ></i>
                                        <div>
                                          <h6>Family Miles Account</h6>
                                          <p>
                                            Connect your family to earn and
                                            spend miles as one.
                                          </p>
                                        </div>
                                      </a>
                                    ...
                                    <div className="row g-0">
                                      ...
                                      >
                                        ...
                                        <div>
                                          <h6>Redeem</h6>
                                          <p>
                                            Use nasmiles to book flights and
                                            extras
                                          </p>
                                        </div>
                                      </a>
                                      ...
                                      >
                                        ...
                                        <div>
                                          <h6>Our lounges</h6>
                                          <p>
                                            Relax in lounges using your miles
                                          </p>
                                        </div>
                                      </a>
                                      <a
                                      ...
                                      >
                                        ...
                                        <div>
                                          ...
                                          <p>
                                            Track and redeem miles from your
                                            phone
                                          </p>
                                        </div>
                                      </a>
                                    ...
                                    <div className="row g-0">
                                      ...
                                      >
                                        ...
                                        <div>
                                          ...
                                          <p>
                                            Learn how the loyalty program works
                                          </p>
                                        </div>
                                      </a>
                                      <a
                                      ...
                                      >
                                        <i
                                          style={{
                                            backgroundPosition: "-321px -132px",
                                          }}
                                        ></i>
                                        <div>
                                          <h6>Tiers and benefits</h6>
                                          <p>
                                            Discover perks based on your tier
                                          </p>
                                        </div>
                                      </a>
                                      <a
                                      ...
                                      >
                                        <i
                                          style={{
                                            backgroundPosition: "-117px -9.5px",
                                          }}
                                        ></i>
                                        <div>
                                          <h6>Join nasmiles</h6>
                                      ...
                                      >
                                        ...
                                        <div>
                                          <h6>Partners</h6>
                                          <p>
                                            Earn and spend with our partners
                                          </p>
                                        </div>
                                      </a>
                                      <a
                                ...
                                <div className="accordion-body p-0">
                                  <div className="accordion accordion-flush ms-2">
                                    <div className="accordion-item">
                                      ...
                                      <div
                                        id="acc-child-3-79760ba3-1a4a-46b3-aa5c-a9d811c451e2"
                                        className="accordion-collapse collapse"
                                      >
                                        <div className="accordion-body p-0">
                                          <a
                                  ...
                                  <div className="accordion accordion-flush ms-2">
                                    <div className="accordion-item">
                                      ...
                                      <div
                                        id="acc-child-3-8e08ead0-ca59-4013-bbab-702d48f1e88c"
                                        className="accordion-collapse collapse"
                                      >
                                        <div className="accordion-body p-0">
                                          <a
                                  ...
                                  <div className="accordion accordion-flush ms-2">
                                    <div className="accordion-item">
                                      ...
                                      <div
                                        id="acc-child-3-a5ce65c0-0b7c-477d-a276-ea5c13d4b321"
                                        className="accordion-collapse collapse"
                                      >
                                        <div className="accordion-body p-0">
                                          <a
        ...
        <main className="page-content">
          <section className="section">
            ...
            >
              <div
                ...
                id="swiper-wrapper-bad1bc7ea10f91b7b"
                aria-live="off"
                style={{ transitionDuration: "0ms", transitionDelay: "0ms" }}
              >
                <div
                  className="swiper-slide swiper-slide-next"
                  data-slide-bg="/media/hmhgvktm/vienna_hero-banner-en-plain-1920x780-05.png"
                  role="group"
                  aria-label="4 / 4"
                ...
                >
                  <img
                    alt=""
                    src="./refresh-icon_files/vienna_hero-banner-en-plain-1920x780-05.png"
                    loading="lazy"
                  />

                  <div className="swiper-slide-caption">
                    <div className="container container-bigger swiper-main-section">
                      <div className="row row-fix justify-content-sm-center justify-content-md-start text-center">
                        <div className="col-md-12 col-lg-12 col-xl-12 col-xxl-12">
                          <div className="container text-left">
                            ...
                            <p>
                              <a
                                href="https://www.flynas.com/en/flights-to-vienna"
                ...
                <div
                  ...
                  data-slide-bg="/media/jsbnzrvr/owned-media_hero-banner-en-plain-1920x780.png"
                  role="group"
                  aria-label="1 / 4"
                ...
                >
                  <img
                    alt=""
                    src="./refresh-icon_files/owned-media_hero-banner-en-plain-1920x780.png"
                  />
                      ...
                      <div className="row row-fix justify-content-sm-center justify-content-md-start text-center">
                        <div className="col-md-12 col-lg-12 col-xl-12 col-xxl-12">
                          <div className="container text-left">
                            ...
                            <h4>
                              Between Madina &amp; Brussels from 5 October
                            </h4>
                            <p>
                              <a
                                href="https://www.flynas.com/en/flights-from-medina-to-brussels"
                                className="book-now-btn"
                              >
                                Book Now!
                              </a>
                ...
                <div
                  ...
                  data-slide-bg="/media/hpspltu2/owned-media-2_hero-banner-en-plain-1920x780.png"
                  role="group"
                  aria-label="2 / 4"
                ...
                >
                  <img
                    alt=""
                    src="./refresh-icon_files/owned-media-2_hero-banner-en-plain-1920x780.png"
                    loading="lazy"
                  />
                      ...
                      <div className="row row-fix justify-content-sm-center justify-content-md-start text-center">
                        <div className="col-md-12 col-lg-12 col-xl-12 col-xxl-12">
                          <div className="container text-left">
                            ...
                            <p>
                              <a
                                href="https://www.flynas.com/en/flights-to-kochi-1"
                                className="book-now-btn"
                              >
                                Book Now!
                              </a>
                ...
                <div
                  ...
                  data-slide-bg="/media/za4nhb4g/owned-media-2_hero-banner-en-plain-1920x780.png"
                  role="group"
                  aria-label="3 / 4"
                  ...
                  style={{
                    width: "1065px",
                    opacity: 1,
                    transform: "translate3d(-3195px, 0px, 0px)",
                    transitionDuration: "0ms",
                  }}
                >
                  <img
                    alt=""
                    src="./refresh-icon_files/owned-media-2_hero-banner-en-plain-1920x780(1).png"
                    loading="lazy"
                  />
                      ...
                      <div className="row row-fix justify-content-sm-center justify-content-md-start text-center">
                        <div className="col-md-12 col-lg-12 col-xl-12 col-xxl-12">
                          <div className="container text-left">
                            ...
                            <p>
                              <a
                                href="https://www.flynas.com/en/flights-to-bisha"
                                className="book-now-btn"
                              >
                                Book Now!
                              </a>
              ...
              <div
                ...
                aria-controls="swiper-wrapper-bad1bc7ea10f91b7b"
              ></div>
              <div
              ...
              <div className="container">
                <div className="tab-container shadow-lg rounded-3 search-widget">
                  <div className="widget-menu">
                    <ul className="nav nav-tabs" id="main-tab" role="tablist">
                      ...
                      <li
                        className="nav-item flight-hotel-li"
                        role="presentation"
                      >
                        <a
                          className="nav-link flight-hotel-tab"
                          href="https://www.flynas.com/en#"
                          data-bs-toggle="tab"
                          data-bs-target="#flightsHotel"
                          aria-selected="false"
                          tabIndex="-1"
                          role="tab"
                        >
                      ...
                      >
                        ...
                        >
                          <img
                            src="./refresh-icon_files/41d876f274d39b69f491f169d71ad876_rentcar.png"
                            alt=""
                          />
                  ...
                  <div className="tab-content">
                    ...
                    >
                      ...
                      >
                        <div className="p-3 mobile-style">
                          <div className="row-trip-type my-1 mx-3 pt-3">
                            <div className="row">
                              ...
                              <div className="col-md-2 p-2">
                                <div
                                  className="divstopovercheckbox"
                                  style={{ display: "none" }}
                                >
                                  <div className="form-check form-check-inline cb-stop-over-booking">
                                    <input
                          ...
                          <div
                            className="row my-1 mx-3 mb-0"
                            id="onewayContent"
                          >
                            <div
                              className="col-md-12 mobile-only flight-number single-trip"
                              style={{ display: "none" }}
                            >
                              Flight 1
                            </div>
                            <div className="col-md-6 pe-0 routes-section">
                              <div className="row position-relative station-panel">
                                <div className="col-md-6 col-xs-12 origin-dropdown">
                                  <div className="input-station">
                                    ...
                                    >
                                      ...
                                      <option defaultValue="ABJ">
                                        Abidjan
                                      </option>
                                      <option defaultValue="AUH">
                                        Abu Dhabi
                                      </option>
                                      <option defaultValue="ADD">
                                        Addis Ababa
                                      </option>
                                      <option defaultValue="ABT">
                                        Al Baha
                                      </option>
                                      <option defaultValue="AJF">
                                        Al Jouf
                                      </option>
                                      <option defaultValue="DBB">
                                        Al-alamien
                                      </option>
                                      <option defaultValue="ALP">Aleppo</option>
                                      <option defaultValue="HBE">
                                        Alexandria
                                      </option>
                                      <option defaultValue="ALY">
                                        Alexandria
                                      </option>
                                      <option defaultValue="ALG">
                                        Algiers
                                      </option>
                                      <option defaultValue="ULH">AlUla</option>
                                      <option defaultValue="ADJ">Amman</option>
                                      <option defaultValue="AMM">Amman</option>
                                      <option defaultValue="JO1">
                                        Amman, All Airports
                                      </option>
                                      <option defaultValue="ESB">Ankara</option>
                                      <option defaultValue="HTY">
                                        Antakya
                                      </option>
                                      <option defaultValue="AYT">
                                        Antalya
                                      </option>
                                      ...
                                      <option defaultValue="SLL">
                                        Salalah
                                      </option>
                                      <option defaultValue="SZG">
                                        Salzburg
                                      </option>
                                      <option defaultValue="SJJ">
                                        Sarajevo
                                      </option>
                                      <option defaultValue="ICN">Seoul</option>
                                      <option defaultValue="SEZ">
                                        Seychelles
                                      </option>
                                      <option defaultValue="SHJ">
                                        Sharjah
                                      </option>
                                      <option defaultValue="SSH">
                                        Sharm El-Sheikh
                                      </option>
                                      <option defaultValue="SIN">
                                        Singapore
                                      </option>
                                      <option defaultValue="HMB">Sohag</option>
                                      <option defaultValue="STN">
                                        Stansted
                                      </option>
                                      <option defaultValue="BKK">
                                        Suvarnabhumi
                                      </option>
                                      <option defaultValue="TUU">Tabuk</option>
                                      <option defaultValue="TIF">Taif</option>
                                      <option defaultValue="TAS">
                                        Tashkent
                                      </option>
                                      <option defaultValue="TBS">
                                        Tbilisi
                                      </option>
                                      <option defaultValue="TIA">Tirana</option>
                                      <option defaultValue="TZX">
                                        Trabzon
                                      </option>
                                    ...
                                    >
                                      <span className="selection">
                                        <span
                                          ...
                                          aria-expanded="false"
                                          tabIndex="0"
                                          aria-labelledby="select2-fromStation-container"
                                        >
                                          <span
                                ...
                                <div className="col-md-6 col-xs-12 destination-dropdown position-relative">
                                  <div className="input-station">
                                    <select
                                      className="form-select station-dropdown select2-hidden-accessible"
                                      id="toStation"
                                    ...
                                    >
                                      <span className="selection">
                                        <span
                                          ...
                                          aria-expanded="false"
                                          tabIndex="0"
                                          aria-labelledby="select2-toStation-container"
                                        >
                                          <span
                                            className="select2-selection__rendered"
                                            id="select2-toStation-container"
                                          >
                                            <span className="select2-selection__placeholder">
                                              Destination
                                            </span>
                            ...
                            <div className="col-md-4 date-range-cell position-relative ps-0">
                              ...
                              <div className="row mt-0 border-bottom mx-1 mobile-date-range-cell">
                                <div className="col-md-6 depart-date-select position-relative ps-0 pe-0">
                            ...
                            <div className="col-md-2 btn-flight-search-pre-submit text-center">
                              <button
                                className="btn btn-primary m-0 rounded-2"
                                id="btnFlightSearchPreSubmit"
                                type="submit"
                              >
                                Search
                              </button>
                          ...
                          >
                            <div className="col-md-12">
                              <div className="row">
                                ...
                                >
                                  <div
                                    className="row my-1 mx-3 multi-city-row m-t-10"
                                    id="multiCityRow1"
                                  >
                                    ...
                                    <div className="col-md-6 pe-0 routes-section">
                                      <div className="row position-relative station-panel">
                                        <div className="col-md-6 col-xs-12 origin-dropdown position-relative">
                                          <div className="input-station">
                                            <select
                                    ...
                                    <div className="col-md-4 date-range-cell ps-0">
                                      ...
                                      <div className="row mt-0 border-bottom mx-1">
                                        <div className="col-md-12 depart-date-select position-relative ps-0 pe-0">
                                          <div>
                                            <label htmlFor="">Depart</label>
                                            <br />
                                            <span
                                  ...
                                  <div
                                    className="row my-1 mx-3 multi-city-invisible-row m-t-10"
                                    style={{ display: "none" }}
                                  >
                                    <div className="col-md-12 mobile-only flight-number">
                                      Flight
                          ...
                          <div
                            className="row mx-3 mt-4 mb-4"
                            id="pnlAdditionSearchDetails"
                            style={{ display: "none" }}
                          >
                            <div className="col-md-3 passengers-select-btn">
                              <label htmlFor="lblPassengerDetails">
                                Passengers
                              </label>
                              <div className="d-block passengers-dropdown">
                                <button
                                  ...
                                  aria-haspopup="true"
                                  aria-expanded="false"
                                  id="btnPassengerDetails"
                                >
                                  <i className="fa fa-user d-inline-block item-icon"></i>
                                  1
                                </button>
                                <div className="dropdown-menu p-4">
                                  <div className="mb-3">
                                    <div className="row">
                                      <div className="col-md-6 d-flex align-items-center">
                                        <i className="fa-solid fa-user d-inline-block item-icon"></i>
                                        <label
                                          htmlFor=""
                                          className="d-inline-block"
                                        >
                                          Adult
                                          <span className="d-block dropdown-item-description">
                                            12+ years
                                          </span>
                                        </label>
                                      </div>
                                      <div className="col-md-6 text-right">
                                        <button
                                          className="btn btn-sm btn-increment"
                                          data-passengertype="adult"
                                          data-operator="-"
                                          type="button"
                                          disabled="disabled"
                                        >
                                          <i className="fa-solid fa-minus fa-bold"></i>
                                        </button>
                                        <span
                                          className="span-passenger-count"
                                          id="lblAdultCount"
                                          data-passengertype="adult"
                                        >
                                          1
                                  ...
                                  <div className="mb-3">
                                    <div className="row">
                                      <div className="col-md-6 d-flex align-items-center">
                                        <i className="fa-solid fa-child d-inline-block item-icon"></i>
                                        <label
                                          htmlFor=""
                                          className="d-inline-block"
                                        >
                                  ...
                                  <div className="mb-3">
                                    <div className="row">
                                      <div className="col-md-6 d-flex align-items-center">
                                        <i className="fa-solid fa-baby d-inline-block item-icon"></i>
                                        <label
                                          htmlFor=""
                                          className="d-inline-block"
                                        >
                                  ...
                                  <div
                                    className="mb-3 group-booking-text"
                                    style={{ display: "none" }}
                                  >
                                    <div className="row">
                                      <div className="col-md-12">
                                        <b>Sorry</b>, you can book online for a
                                        maximum of 9 passengers. For group
                                        booking email us at
                                        <a href="mailto: groupsdesk@flynas.com">
                                          groupsdesk@flynas.com
                                        </a>
                                        for assistance.
                                      </div>
                                    </div>
                              ...
                              <div className="">
                                ...
                                <div className="custom-select">
                                  ...
                                  >
                                    ...
                                    <option defaultValue="AED">
                                      UAE Dirham
                                    </option>
                                    <option defaultValue="KWD">
                                      Kuwait Dinar
                                    </option>
                                    <option defaultValue="BHD">
                                      Bahraini Dinar
                                    </option>
                                    <option defaultValue="JOD">
                                      Jordanian Dinar
                                    </option>
                                    <option defaultValue="RUB">
                                      Russian Ruble
                                    </option>
                                  </select>
                            ...
                            <div className="col-auto d-flex flight-search-links">
                              <div className="d-inline align-self-end">
                                <a
                                  href="https://www.flynas.com/en/book-flight"
                                  className="me-3"
                                >
                                  <i className="fa-solid fa-route pe-1"></i>
                                  Where we fly?
                                </a>
                            ...
                            <div className="col-auto btn-flight-search-submit px-0 text-center">
                              <button
                                className="btn btn-primary m-0 rounded-2 d-inline-block"
                                id="btnFlightSearchSubmit"
                                type="submit"
                              >
                                Search
                              </button>
                          ...
                          <div
                            className="row mx-3 mt-1 pb-3"
                            id="pnlStopOverBooking"
                            style={{ display: "none" }}
                          >
                            <div className="col-md-10">
                              <div className="row  p-3 stop-over-panel">
                                <div className="col-md-7">
                                  <div>
                                    <label htmlFor="">
                                      Where would you like to add a stop in
                                      Saudi during your journey?
                                    </label>
                                  </div>
                                  <div className="mt-1 mob-bot-pad">
                                    <div className="form-check form-check-inline">
                                      <input
                                        className="form-check-input radio-custom"
                                        type="radio"
                                        name="StopOverTripDirection"
                                        id="rdStopOverDeparture"
                                        defaultChecked=""
                                    ...
                                    <div className="form-check-inline ddl-select-stopover-city">
                                      <div className="position-relative custom-select">
                                        ...
                                        >
                                          ...
                                          <option defaultValue="RUH">
                                            Riyadh (RUH)
                                          </option>
                                          <option defaultValue="JED">
                                            Jeddah (JED)
                                          </option>
                                        </select>
                                        <div
                                ...
                                <div className="col-md-5">
                                  ...
                                  <div className="mt-3">
                                    <button
                                      className="btn btn-xs btn-primary disabled"
                                      id="btnStopOverDecrementDays"
                                      type="button"
                                    >
                                      <i className="fa-solid fa-minus mx-0"></i>
                                    </button>
                                    <label htmlFor="" id="lblStopOverDaysCount">
                                      1
                                    </label>
                                    <button
                                      className="btn btn-xs btn-primary"
                                      id="btnStopOverIncrementDays"
                                      type="button"
                                    >
                                      <i className="fa-solid fa-plus mx-0"></i>
                                    </button>
                                  </div>
                                </div>
                              </div>
                            </div>
                            <div className="col-md-2 stop-over-submit-placeholder my-auto text-center"></div>
                          </div>
                          <div
                            id="hhrSection"
                            className="row hhr-section mx-3 mt-4"
                            style={{ display: "none" }}
                          >
                            <div className="col-lg-6 col-12">
                              <div className="checkbox checkbox2 nopad d-flex align-items-center hhr-checkbox">
                                <label id="hhrlabel">
                                  <input
                                    type="checkbox"
                    ...
                    <div
                      className="tab-pane pb-4"
                      id="flightsHotel"
                      role="tabpanel"
                    >
                      <div className="p-3 mobile-style">
                        <div
                          className="col-md-6 col-12 row d-flex align-items-center flights-hotel-radios"
                          id="hotelUmrahPackage"
                        >
                          <div className="col-md-6 col-12 form-check form-check-inline  align-items-center flight-hotel-radio">
                            <input
                              className="form-check-input radio-custom"
                              type="radio"
                              name="package-type"
                              id="hotel"
                              defaultValue="flightsHotel"
                              defaultChecked="checked"
                            />
                            <span className="radio-custom-dummy"></span>
                          ...
                          <div className="col-md-6 col-12 form-check form-check-inline d-flex align-items-lg-end align-items-center">
                            <input
                              className="form-check-input radio-custom"
                              type="radio"
                              name="package-type"
                              id="package"
                              defaultValue="umrahPackages"
                            />
                            <span className="radio-custom-dummy"></span>
                            <label
                              className="form-check-label"
                            ...
                            <div className="col-md-6 round-trip-panel">
                              ...
                              >
                                <input
                                  ...
                                  name="nas-trip-type"
                                  id="nasTripOneway"
                                  defaultValue="nasoneway"
                                />
                                <span className="radio-custom-dummy"></span>
                                <label
                                  className="form-check-label"
                                  htmlFor="nasTripOneway"
                                >
                                  One Way
                                </label>
                              </div>
                              ...
                              >
                                <input
                                  ...
                                  name="nas-trip-type"
                                  id="nasTripTwoWay"
                                  defaultValue="nasround"
                                  defaultChecked="checked"
                                />
                                <span className="radio-custom-dummy"></span>
                                <label
                                  className="form-check-label"
                                  htmlFor="nasTripTwoWay"
                                >
                                  Round trip
                                </label>
                              </div>
                        ...
                        >
                                  ...
                                  >
                                    <span className="selection">
                                      <span
                                        ...
                                        aria-expanded="false"
                                        tabIndex="0"
                                        aria-labelledby="select2-nasFromStation-container"
                                      >
                                        <span
                                          className="select2-selection__rendered"
                                  ...
                                  >
                                    <span className="selection">
                                      <span
                                        ...
                                        aria-expanded="false"
                                        tabIndex="0"
                                        aria-labelledby="select2-nasToStation-container"
                                      >
                                        <span
                                          className="select2-selection__rendered"
                                          id="select2-nasToStation-container"
                                        >
                                          <span className="select2-selection__placeholder">
                                            Destination
                                          </span>
                          ...
                          <div className="col-md-4 date-range-cell position-relative ps-0">
                            ...
                            <div className="row mt-0 border-bottom mx-1 mobile-date-range-cell">
                              <div className="col-md-6 depart-date-select position-relative ps-0 pe-0">
                                ...
                                <span
                                  className="selected-date"
                                  id="naslblDepartureDate"
                                  name="nasDepartureDate"
                                >
                                  07 Aug 26
                                </span>
                                <div className="invalid-tooltip">
                              ...
                              <div className="col-md-6 return-date-select ps-0 pe-0">
                                <label
                                  id="naslblArrivalLabel"
                                  htmlFor="naslblArrivalLabel"
                                >
                                  Return
                                </label>
                                <label
                                  id="naslblCheckoutLabel"
                                  htmlFor="naslblCheckoutLabel"
                                  style={{ display: "none" }}
                                >
                                  Check-Out
                                </label>
                          ...
                          <div className="col-md-2 position-relative ps-0 occupency-cell">
                            <div className="row mt-0 border-bottom mx-1 mobile-date-range-cell">
                              ...
                              <input
                                type="text"
                                readOnly=""
                                className="no-focus rounded-0 border-0"
                                name="Occupancy"
                                id="txtOccupancy"
                                required=""
                              />
                                  ...
                                  <div className="people_div">
                                    <div className="row mb-3">
                                      <div className="col-7 d-flex align-items-center">
                                        <label className="people_lbl">
                                          Adults <br />
                                          <span className="people_desc">
                                            12+ years
                                          </span>
                                        </label>
                                      </div>
                                      <div className="col-5 d-flex align-items-center justify-content-end">
                                        <div className="addbtncon-btn my-auto top-0">
                                          <button className="decrement-adults">
                                            <span>-</span>
                                          </button>
                                          <input
                                            type="text"
                                            ...
                                            id="adults-0"
                                          />
                                          <button className="increment-adults">
                                            <span>+</span>
                                          </button>
                                        </div>
                                      </div>
                                    ...
                                    <div className="row">
                                      ...
                                      <div className="col-5 d-flex align-items-center justify-content-end">
                                        <div className="addbtncon-btn my-auto top-0">
                                          <button className="decrement-children">
                                            <span>-</span>
                                          </button>
                                          <input
                                            type="text"
                                            ...
                                            id="children-0"
                                          />
                                          <button className="increment-children">
                                            <span>+</span>
                                          </button>
                                        </div>
                                      </div>
                          ...
                          <div className="col-md-1">
                            <button
                              className="btn btn-primary rounded-1 m-0 btn-search"
                              id="btnNasSearch"
                              type="submit"
                            >
                              Search
                    ...
                    <div className="tab-pane" id="manage" role="tabpanel">
                      <div className="p-3">
                        <form
                          className="row px-3 pt-4 needs-validation form-home-search-widget"
                          novalidate=""
                          id="formFsManageBooking"
                        >
                          <h3 className="mobile-only text-white mb-2">
                            Manage My Booking
                          </h3>
                          ...
                          <div className="col-md-2 pt-3 btn-search-section">
                            <button
                              className="btn btn-primary rounded-2 btn-search"
                              id="btnBookingSearch"
                              type="submit"
                            >
                              Find Booking
                        ...
                        <div className="row m-0 pt-3">
                          <span className="text-dark">
                            Manage your flight at your convenience
                          </span>
                        </div>
                      </div>
                    </div>
                    <div className="tab-pane" id="checkin" role="tabpanel">
                      <div className="p-3">
                        ...
                        <div className="row m-0 pt-3">
                          <span className="text-dark">
                            Save valuable time, check-in for your flight
                          </span>
                        </div>
                      </div>
                    </div>
                    <div className="tab-pane" id="flightStatus" role="tabpanel">
                      <div className="p-3">
                          ...
                          <div className="col-md-2">
                            <label className="radio-label">
                              <input
                                ...
                                defaultValue="route"
                              />
                              <span className="radio-custom-dummy"></span>Search
                              by route
                            </label>
                          </div>
                        ...
                        <form
                          className="row p-0 m-0 px-3 needs-validation form-home-search-widget"
                          novalidate=""
                        >
                              ...
                              <div className="col-md-6 position-relative">
                                <div className="input-station">
                                  ...
                                  >
                                    ...
                                    <option defaultValue="AGA">
                                      Agadir Almassira Airport
                                    </option>
                                    <option defaultValue="AJI">
                                      Agri Airport
                                    </option>
                                    <option defaultValue="AMD">
                                      Ahmedabad
                                    </option>
                                    <option defaultValue="ABT">Al Baha</option>
                                    <option defaultValue="AJF">Al Jouf</option>
                                    ...
                                    <option defaultValue="AMS">
                                      Amsterdam
                                    </option>
                                    <option defaultValue="AOE">
                                    ...
                                    <option defaultValue="BLR">
                                      Bengaluru
                                    </option>
                                    <option defaultValue="BER">Berlin</option>
                                    <option defaultValue="BHO">Bhopal</option>
                                    <option defaultValue="BBI">
                                      Bhubaneswar
                                    </option>
                                    <option defaultValue="BHX">
                                      Birmingham
                                    ...
                                    <option defaultValue="IXC">
                                      Chandigarh
                                    </option>
                                    <option defaultValue="MAA">Chennai</option>
                                    <option defaultValue="CGN">Cologne</option>
                                    <option defaultValue="CZL">
                                      Constantine
                                    </option>
                                    <option defaultValue="CPH">
                                      Copenhagen
                                    </option>
                                    <option defaultValue="NCE">
                                      Cote D'Azur Airport
                                    </option>
                                    ...
                                    <option defaultValue="DOH">Doha</option>
                                    <option defaultValue="DXB">Dubai</option>
                                    <option defaultValue="DWC">
                                      Dubai-Al Maktoum
                                    </option>
                                    <option defaultValue="AE1">
                                      Dubai, All Airports
                                    </option>
                                    <option defaultValue="DUS">
                                      Düsseldorf
                                    </option>
                                    <option defaultValue="EDI">
                                      Edinburgh
                                    </option>
                                    ...
                                    <option defaultValue="IKA">
                                      Imam Khomeini International Airp
                                    </option>
                                    ...
                                    <option defaultValue="KHI">Karachi</option>
                                    <option defaultValue="KFS">
                                      Kastamonu
                                    </option>
                                    <option defaultValue="KTM">
                                      Kathmandu
                                    </option>
                                    ...
                                    <option defaultValue="GHA">
                                      Noumerate
                                    </option>
                                    <option defaultValue="NCU">
                                      Nukus Airport
                                    </option>
                                    <option defaultValue="OGU">
                                      Ordu Giresun
                                    </option>
                                    <option defaultValue="OSS">Osh</option>
                                    <option defaultValue="CDG">Paris</option>
                                    ...
                                    <option defaultValue="RSI">
                                      Red Sea International Airport
                                    </option>
                                    <option defaultValue="RUH">Riyadh</option>
                                    <option defaultValue="RZV">Rize</option>
                                    <option defaultValue="FCO">Rome</option>
                                    <option defaultValue="FEZ">
                                      Sais Airport
                                    </option>
                                    <option defaultValue="SLL">Salalah</option>
                                    <option defaultValue="SZG">Salzburg</option>
                                    <option defaultValue="SZF">Samsun</option>
                                    <option defaultValue="GNY">
                                      Sanliurfa Gap
                                    </option>
                                    <option defaultValue="JTR">
                                      Santorini
                                    </option>
                                    <option defaultValue="GRU">
                                      Sao Paulo
                                    </option>
                                    <option defaultValue="SJJ">Sarajevo</option>
                                    <option defaultValue="ICN">Seoul</option>
                                    ...
                                    <option defaultValue="TJK">
                                      Tokat Airport
                                    </option>
                                    <option defaultValue="TZX">Trabzon</option>
                                    <option defaultValue="TRV">
                                      Trivandrum
                                    </option>
                                    <option defaultValue="TUN">Tunis</option>
                                    <option defaultValue="TUI">Turaif</option>
                                    <option defaultValue="TZL">
                                  ...
                                  >
                                    <span className="selection">
                                      <span
                                        ...
                                        aria-expanded="false"
                                        tabIndex="0"
                                        aria-labelledby="select2-fsFromStation-container"
                                      >
                                        <span
                                          className="select2-selection__rendered"
                                  ...
                                  >
                                    <span className="selection">
                                      <span
                                        ...
                                        aria-expanded="false"
                                        tabIndex="0"
                                        aria-labelledby="select2-fsToStation-container"
                                      >
                                        <span
                                          className="select2-selection__rendered"
                                          id="select2-fsToStation-container"
                                        >
                                          <span className="select2-selection__placeholder">
                                            Destination
                                          </span>
                          ...
                          <div className="col-md-3 pt-2">
                            <div className="custom-select">
                              ...
                              <div className="select-items select-hide">
                                <div>TOMORROW, 08 Aug 26</div>
                                <div className="select-default">
                                  TODAY, 07 Aug 26
                                </div>
                                <div>YESTERDAY, 06 Aug 26</div>
                              </div>
                            </div>
                          </div>
                          <div className="col-md-2">
                        ...
                        <div
                          className="row m-0 pt-3 px-3 text-fs-searchby-flightnumber"
                          style={{ display: "none" }}
                        >
                          <span className="text-dark">
                            Enter flight number without carrier code.
                          </span>
                        </div>
                      </div>
                    </div>
                ...
                <div className="sticky-links-mobile mx-3 mt-4">
                  <div className="sticky-links-item rounded-2 umrah-item">
                    <a
                      href="https://nasholidays.com/umrah_packages/en"
                      target="_blank"
                    >
                      <i className="umrah-package-icon me-3 ms-2"></i>
                      <span>Umrah</span>
                    </a>
                  </div>
                  <div className="sticky-links-item rounded-2">
                    <a
                      href="https://www.booking.com/?aid=922212&amp;amplabel=flynas-des-homepage-bed-icon/en"
                      target="_blank"
                    >
                      <i className="fa-color fa fa-bed me-2 ms-2"></i>
                      <span>Hotels</span>
                    </a>
                  </div>
                  <div className="sticky-links-item rounded-2">
                    <a
                      ...
                      target="_blank"
                    >
                      <i className="fa-color fa fa-car me-2 ms-2"></i>
                      <span>Car</span>
                    </a>
                  </div>
                </div>
            ...
            ></div>
            <div
              id="createaccountpopupnasmiles"
              className="popup-container mob-popup-container"
              style={{ display: "none" }}
            >
              <div className="popup-content">
                <div className="card-header">
                  <i className="nasmile_join_icon"></i>
                  <h5 className="card-title text-start">Join nasmiles</h5>
                  <a
                    className="close"
                    id="createAccountPopupclose"
                    href="https://www.flynas.com/en#"
                  >
                    ×
                  </a>
                ...
                <div className="card-body">
                  <ul>
                    <li className="row d-flex m-0 pb-2">
                      ...
                      <p className="col-10 p-0 my-auto">Enjoy Faster Booking</p>
                    </li>
                    <li className="row d-flex m-0 pb-2">
                      <i className="flight_icon col-1 p-0"></i>
                    ...
                    <li className="row d-flex m-0 pb-2">
                      <i className="flight_icon col-1 p-0"></i>
                      <p className="col-10 p-0 my-auto">Exclusive offers</p>
                    </li>
                  </ul>
                  <button
          ...
          <section className="section section-sm bg-default novi-background bg-cover">
            <div className="">
              <div
                className="summer-destinations-carousel-section py-lg-5"
                style={{
                  backgroundImage: "url(&#39",
                  https:
                    "//static.flynas.com/media/ynthzuv1/summer-deal-banner-2026.png&#39",
                }}
              >
                <h3 className="text-white text-center mb-4 summer-destinations-title">
                  Our Summer Destinations
                </h3>
                <div className="container">
                  <div
                    className="slider summer-destinations-carousel slick-initialized slick-slider"
                    dir="ltr"
                  >
                    <button
                    ...
                    <div className="slick-list draggable">
                      ...
                      >
                        ...
                        >
                          <div>
                            <div
                              data-item-interval="5000"
                              style={{ width: "100%", display: "inline-block" }}
                            >
                              <div className="summer-destinations-layer">
                                <a
                                  href="https://www.flynas.com/en/flights-to-maldives"
                                  tabIndex="-1"
                                >
                                  <div className="card position-relative rounded-0">
                                    ...
                                    <div className="card-image">
                                      <figure>
                                        <img
                                          src="./refresh-icon_files/maldives-250x400.png"
                                          loading="lazy"
                                          width="250"
                                          height="400"
                                          alt=""
                        ...
                        >
                          <div>
                            ...
                            >
                              <div className="summer-destinations-layer">
                                <a
                                  href="https://www.flynas.com/en/flights-to-podgorica"
                                  tabIndex="-1"
                                >
                                  <div className="card position-relative rounded-0">
                                    <div
                                    ...
                                    <div className="card-image">
                                      <figure>
                                        <img
                                          src="./refresh-icon_files/montenegro-250x400.png"
                                          loading="lazy"
                                          width="250"
                                          height="400"
                                          alt=""
                        ...
                        >
                          <div>
                            ...
                            >
                              <div className="summer-destinations-layer">
                                <a
                                  href="https://www.flynas.com/en/flights-to-prague"
                                  tabIndex="-1"
                                >
                                  <div className="card position-relative rounded-0">
                                    <div
                                    ...
                                    <div className="card-image">
                                      <figure>
                                        <img
                                          src="./refresh-icon_files/prague-250x400.png"
                                          loading="lazy"
                                          width="250"
                                          height="400"
                                          alt=""
                        ...
                        >
                          <div>
                            ...
                            >
                              <div className="summer-destinations-layer">
                                <a
                                  href="https://www.flynas.com/en/flights-to-rize"
                                  tabIndex="-1"
                                >
                                  <div className="card position-relative rounded-0">
                                    <div
                                    ...
                                    <div className="card-image">
                                      <figure>
                                        <img
                                          src="./refresh-icon_files/rize-250x400.png"
                                          loading="lazy"
                                          width="250"
                                          height="400"
                                          alt=""
                        ...
                        >
                          <div>
                            ...
                            >
                              <div className="summer-destinations-layer">
                                <a
                                  href="https://www.flynas.com/en/flights-to-Tirana"
                                  tabIndex="0"
                                >
                                  <div className="card position-relative rounded-0">
                                    <div
                                    ...
                                    <div className="card-image">
                                      <figure>
                                        <img
                                          src="./refresh-icon_files/tirana-250x400.png"
                                          width="250"
                                          height="400"
                                          alt=""
                                        />
                        ...
                        >
                          <div>
                            ...
                            >
                              <div className="summer-destinations-layer">
                                <a
                                  href="https://www.flynas.com/en/flights-to-istanbul"
                                  tabIndex="0"
                                >
                                  <div className="card position-relative rounded-0">
                                    <div
                                    ...
                                    <div className="card-image">
                                      <figure>
                                        <img
                                          src="./refresh-icon_files/istanbul-250x400.png"
                                          loading="lazy"
                                          width="250"
                                          height="400"
                                          alt=""
                        ...
                        >
                          <div>
                            ...
                            >
                              <div className="summer-destinations-layer">
                                <a
                                  href="https://www.flynas.com/en/flights-to-sarajevo"
                                  tabIndex="0"
                                >
                                  <div className="card position-relative rounded-0">
                                    <div
                                    ...
                                    <div className="card-image">
                                      <figure>
                                        <img
                                          src="./refresh-icon_files/sarajevo-250x400.png"
                                          loading="lazy"
                                          width="250"
                                          height="400"
                                          alt=""
                        ...
                        >
                          <div>
                            ...
                            >
                              <div className="summer-destinations-layer">
                                <a
                                  href="https://www.flynas.com/en/flights-to-munich"
                                  tabIndex="0"
                                >
                                  <div className="card position-relative rounded-0">
                                    <div
                                      className="ribbon"
                                      style={{ backgroundColor: "#f08624" }}
                                    >
                                      New
                                    </div>
                                    <div className="card-image">
                                      <figure>
                                        <img
                                          src="./refresh-icon_files/munich-250x400.png"
                                          loading="lazy"
                                          width="250"
                                          height="400"
                                          alt=""
          ...
          <div className="section section-sm novi-background bg-cover pt-5 pb-5">
            <div className="container container-bigger">
              ...
              <div>
                Explore the additional services we offer to make your journey
                even more memorable.
              </div>
              <div className="row justify-content-sm-center text-center pt-4">
                <div className="col-sm-10 col-md-6 col-xl-3 mb-3">
                  <div className="h-100 d-flex flex-column box-minimal box-minimal-border p-0">
                    <div className="box-minimal-icon novi-icon">
                      <img
                        alt=""
                    ...
                    <div className="d-flex flex-column  flex-grow-1">
                      <h4 className="enjoy-trip-sub-heading mb-3">
                        Extra Baggage
                      </h4>
                      <div className=" text-spacing-sm mb-3 flex-grow-1">
                        Save up to 50% from airports prices, add your extra
                        baggage now.
                      </div>
                      <div className="box-minimal-footer mb-3 mt-auto">
                        <a
                ...
                <div className="col-sm-10 col-md-6 col-xl-3 mb-3">
                  <div className="h-100 d-flex flex-column  box-minimal box-minimal-border p-0">
                    ...
                    <div className="d-flex flex-column  flex-grow-1">
                      ...
                      <div className="text-spacing-sm mb-3 flex-grow-1">
                        Feeling hungry? Choose one of our delicious meals to be
                        specially served to you on your trip.
                      </div>
                      <div className="box-minimal-footer mt-auto mb-3">
                        <a
                          href="https://www.flynas.com/en/plan-my-trip/pre-order-meals"
                          className="btn btn-primary btn-sm"
                        >
                ...
                <div className="col-sm-10 col-md-6 col-xl-3 mb-3">
                  <div className="h-100 d-flex flex-column box-minimal box-minimal-border p-0">
                    ...
                    <div className="d-flex flex-column  flex-grow-1">
                      ...
                      <div className="text-spacing-sm mb-3 flex-grow-1">
                        Hurry! Don’t miss your chance to sit on your preferred
                        seat.
                      </div>
                      <div className="box-minimal-footer mt-auto mb-3">
                        <a
                ...
                <div className="col-sm-10 col-md-6 col-xl-3 mb-3">
                  <div className="h-100 d-flex flex-column  box-minimal box-minimal-border p-0">
                    ...
                    <div className="d-flex flex-column  flex-grow-1">
                      ...
                      <div className="text-spacing-sm mb-3 flex-grow-1">
                        With flynas, you can now upgrade your flight to Premium
                        Class, ensuring a luxurious and comfortable arrival at
                        your destination.
                      </div>
                      <div className="box-minimal-footer mt-auto mb-3">
                        <a
          ...
          <div className="section novi-background bg-cover bg-gray-lighter desktop-only text-center">
            <a href="https://www.flynas.com/en/dynamic-routemap">
              <img
                alt=""
                src="./refresh-icon_files/flynas_combined.gif"
                width="100%"
                height="100%"
                loading="lazy"
              />
          ...
          <div className="section novi-background bg-cover bg-gray-lighter mobile-only text-center">
            <a href="https://www.flynas.com/en/dynamic-routemap">
              <img
                alt=""
                src="./refresh-icon_files/flynas_combined.gif"
          ...
          <section className="section section-sm bg-gray-lighter novi-background bg-cover text-center">
            <div className="container desktop-only text-center">
              <a href="https://www.flynas.com/en/payment-methods">
                <img
                  alt=""
                  src="./refresh-icon_files/owned-media_1200-ù-190.png"
                />
              </a>
            </div>

            <div className="container-bigger mobile-only">
              <a href="https://www.flynas.com/en/payment-methods">
                <img
                  alt=""
                  src="./refresh-icon_files/owned-media_750-ù-446-19.png"
                />
              </a>
            </div>
          </section>
          ...
          <section
            className="section section-sm bg-default novi-background bg-cover"
            style={{ zIndex: 1 }}
          >
            <div className="container">
                        ...
                        <div className="slick-list draggable">
                          <div
                            ...
                            style={{
                              opacity: 1,
                              width: "5126px",
                              transform: "translate3d(-932px, 0px, 0px)",
                            }}
                          >
                            <div
                              className="slick-slide slick-cloned"
                                  ...
                                  <div className="multiple-items-7-layer">
                                    <div className="card position-relative rounded-5">
                                      <div className="card-image">
                                        <figure>
                                          <img
                                            src="./refresh-icon_files/hot-deals-update-_sarajevo.jpg"
                                            loading="lazy"
                                            width="250"
                                            height="400"
                                            alt=""
                                      ...
                                      <div className="card-img-overlay text-center h-100 d-flex flex-column justify-content-end">
                                        <div className="card-title">
                                          <h5 className="text-light">
                                            Sarajevo
                                          </h5>
                                        </div>
                                        <p className="card-text mt-2 text-light">
                                          From
                                        </p>
                                        <p className="card-text mt-2 text-light fw-bold txt-price">
                                        ...
                                        <p className="card-button mt-2 text-light">
                                          <a
                                  ...
                                  <div className="multiple-items-7-layer">
                                    <div className="card position-relative rounded-5">
                                      <div className="card-image">
                                        <figure>
                                          <img
                                            src="./refresh-icon_files/hot-deals-update-_baku.jpg"
                                            loading="lazy"
                                            width="250"
                                            height="400"
                                            alt=""
                                  ...
                                  <div className="multiple-items-7-layer">
                                    <div className="card position-relative rounded-5">
                                      <div className="card-image">
                                        <figure>
                                          <img
                                            src="./refresh-icon_files/hot-deals-update-_istambul.jpg"
                                            loading="lazy"
                                            width="250"
                                            height="400"
                                            alt=""
                                  ...
                                  <div className="multiple-items-7-layer">
                                    <div className="card position-relative rounded-5">
                                      <div className="card-image">
                                        <figure>
                                          <img
                                            src="./refresh-icon_files/cairo-521x834.png"
                                            loading="lazy"
                                            width="250"
                                            height="400"
                                            alt=""
                                  ...
                                  <div className="multiple-items-7-layer">
                                    <div className="card position-relative rounded-5">
                                      <div className="card-image">
                                        <figure>
                                          <img
                                            src="./refresh-icon_files/krakow-hot-deals.png"
                                            width="250"
                                            height="400"
                                            alt=""
                                          />
                                  ...
                                  <div className="multiple-items-7-layer">
                                    <div className="card position-relative rounded-5">
                                      <div className="card-image">
                                        <figure>
                                          <img
                                            src="./refresh-icon_files/hot-deals-update-_tirana.webp"
                                            loading="lazy"
                                            width="250"
                                            height="400"
                                            alt=""
                                  ...
                                  <div className="multiple-items-7-layer">
                                    <div className="card position-relative rounded-5">
                                      <div className="card-image">
                                        <figure>
                                          <img
                                            src="./refresh-icon_files/hot-deals-update-_tbilisi.jpg"
                                            loading="lazy"
                                            width="250"
                                            height="400"
                                            alt=""
                                  ...
                                  <div className="multiple-items-7-layer">
                                    <div className="card position-relative rounded-5">
                                      <div className="card-image">
                                        <figure>
                                          <img
                                            src="./refresh-icon_files/hot-deals-update-_abha.jpg"
                                            loading="lazy"
                                            width="250"
                                            height="400"
                                            alt=""
                                  ...
                                  <div className="multiple-items-7-layer">
                                    <div className="card position-relative rounded-5">
                                      <div className="card-image">
                                        <figure>
                                          <img
                                            src="./refresh-icon_files/cairo-521x834(1).png"
                                            loading="lazy"
                                            width="250"
                                            height="400"
                                            alt=""
                                  ...
                                  <div className="multiple-items-7-layer">
                                    <div className="card position-relative rounded-5">
                                      <div className="card-image">
                                        <figure>
                                          <img
                                            src="./refresh-icon_files/antalya.jpg"
                                            loading="lazy"
                                            width="250"
                                            height="400"
                                            alt=""
                                  ...
                                  <div className="multiple-items-7-layer">
                                    <div className="card position-relative rounded-5">
                                      <div className="card-image">
                                        <figure>
                                          <img
                                            src="./refresh-icon_files/casablanca-521x834.png"
                                            loading="lazy"
                                            width="250"
                                            height="400"
                                            alt=""
                                  ...
                                  <div className="multiple-items-7-layer">
                                    <div className="card position-relative rounded-5">
                                      <div className="card-image">
                                        <figure>
                                          <img
                                            src="./refresh-icon_files/batumi.jpg"
                                            loading="lazy"
                                            width="250"
                                            height="400"
                                            alt=""
                                  ...
                                  <div className="multiple-items-7-layer">
                                    <div className="card position-relative rounded-5">
                                      <div className="card-image">
                                        <figure>
                                          <img
                                            src="./refresh-icon_files/rize-2.jpg"
                                            loading="lazy"
                                            width="250"
                                            height="400"
                                            alt=""
                                  ...
                                  <div className="multiple-items-7-layer">
                                    <div className="card position-relative rounded-5">
                                      <div className="card-image">
                                        <figure>
                                          <img
                                            src="./refresh-icon_files/hot-deals-update-_hurghada.jpg"
                                            loading="lazy"
                                            width="250"
                                            height="400"
                                            alt=""
                                  ...
                                  <div className="multiple-items-7-layer">
                                    <div className="card position-relative rounded-5">
                                      <div className="card-image">
                                        <figure>
                                          <img
                                            src="./refresh-icon_files/north-coast.jpg"
                                            loading="lazy"
                                            width="250"
                                            height="400"
                                            alt=""
                                  ...
                                  <div className="multiple-items-7-layer">
                                    <div className="card position-relative rounded-5">
                                      <div className="card-image">
                                        <figure>
                                          <img
                                            src="./refresh-icon_files/riyadh-521x834.png"
                                            loading="lazy"
                                            width="250"
                                            height="400"
                                            alt=""
                                  ...
                                  <div className="multiple-items-7-layer">
                                    <div className="card position-relative rounded-5">
                                      <div className="card-image">
                                        <figure>
                                          <img
                                            src="./refresh-icon_files/hot-deals-update-_medina.jpg"
                                            loading="lazy"
                                            width="250"
                                            height="400"
                                            alt=""
                                  ...
                                  <div className="multiple-items-7-layer">
                                    <div className="card position-relative rounded-5">
                                      <div className="card-image">
                                        <figure>
                                          <img
                                            src="./refresh-icon_files/hot-deals-update-_abha(1).jpg"
                                            loading="lazy"
                                            width="250"
                                            height="400"
                                            alt=""
                                  ...
                                  <div className="multiple-items-7-layer">
                                    <div className="card position-relative rounded-5">
                                      <div className="card-image">
                                        <figure>
                                          <img
                                            src="./refresh-icon_files/amman-521x834.png"
                                            loading="lazy"
                                            width="250"
                                            height="400"
                                            alt=""
                                  ...
                                  <div className="multiple-items-7-layer">
                                    <div className="card position-relative rounded-5">
                                      <div className="card-image">
                                        <figure>
                                          <img
                                            src="./refresh-icon_files/hot-deals-update-_jizan.jpg"
                                            loading="lazy"
                                            width="250"
                                            height="400"
                                            alt=""
                                  ...
                                  <div className="multiple-items-7-layer">
                                    <div className="card position-relative rounded-5">
                                      <div className="card-image">
                                        <figure>
                                          <img
                                            src="./refresh-icon_files/hot-deals-update-_dubai.jpg"
                                            loading="lazy"
                                            width="250"
                                            height="400"
                                            alt=""
                                  ...
                                  <div className="multiple-items-7-layer">
                                    <div className="card position-relative rounded-5">
                                      <div className="card-image">
                                        <figure>
                                          <img
                                            src="./refresh-icon_files/trabzon-2.jpg"
                                            loading="lazy"
                                            width="250"
                                            height="400"
                                            alt=""
                                  ...
                                  <div className="multiple-items-7-layer">
                                    <div className="card position-relative rounded-5">
                                      <div className="card-image">
                                        <figure>
                                          <img
                                            src="./refresh-icon_files/hot-deals-update-_dammam.jpg"
                                            loading="lazy"
                                            width="250"
                                            height="400"
                                            alt=""
                                  ...
                                  <div className="multiple-items-7-layer">
                                    <div className="card position-relative rounded-5">
                                      <div className="card-image">
                                        <figure>
                                          <img
                                            src="./refresh-icon_files/hot-deals-update-_jeddah.jpg"
                                            loading="lazy"
                                            width="250"
                                            height="400"
                                            alt=""
                                  ...
                                  <div className="multiple-items-7-layer">
                                    <div className="card position-relative rounded-5">
                                      <div className="card-image">
                                        <figure>
                                          <img
                                            src="./refresh-icon_files/hot-deals-update-_dubai.webp"
                                            loading="lazy"
                                            width="250"
                                            height="400"
                                            alt=""
                                  ...
                                  <div className="multiple-items-7-layer">
                                    <div className="card position-relative rounded-5">
                                      <div className="card-image">
                                        <figure>
                                          <img
                                            src="./refresh-icon_files/addis-ababa-3.webp"
                                            loading="lazy"
                                            width="250"
                                            height="400"
                                            alt=""
                                  ...
                                  <div className="multiple-items-7-layer">
                                    <div className="card position-relative rounded-5">
                                      <div className="card-image">
                                        <figure>
                                          <img
                                            src="./refresh-icon_files/hot-deals-update-_cairo.webp"
                                            loading="lazy"
                                            width="250"
                                            height="400"
                                            alt=""
                                  ...
                                  <div className="multiple-items-7-layer">
                                    <div className="card position-relative rounded-5">
                                      <div className="card-image">
                                        <figure>
                                          <img
                                            src="./refresh-icon_files/hot-deals-update-_istambul(1).jpg"
                                            loading="lazy"
                                            width="250"
                                            height="400"
                                            alt=""
          ...
          <div
            id="ReasonsFlyWithUs"
            className="section section-sm bg-gray-lighter novi-background bg-cover"
          >
            <div className="container container-wide">
              ...
              <div className="row justify-content-sm-center text-center">
                <div className="col-4">
                  <div className="book-now">
                    ...
                    >
                      <img
                        alt=""
                        src="./refresh-icon_files/f-hotel-banneren.jpg"
                        className="rounded-3"
                        width="368"
                        height="244"
                        loading="lazy"
                ...
                <div className="col-4">
                  <div className="book-now">
                    ...
                    >
                      <img
                        alt=""
                        src="./refresh-icon_files/f-cars-banneren.jpg"
                        className="rounded-3"
                        width="368"
                        height="244"
                        loading="lazy"
                ...
                <div className="col-4">
                  <div className="book-now nomargin">
                    <a rel="noopener" href="https://www.flynas.com/en/evisa">
                      <img
                        alt=""
                        src="./refresh-icon_files/f-evisa-banneren.jpg"
                        className="rounded-3"
                        width="368"
                        height="244"
                        loading="lazy"
          ...
          <div className="sticky-links">
            <ul>
              <li>
                <a
                  href="https://www.booking.com/?aid=922212&amp;label=flynas-des-homepage-bed-iconen"
                  target="_blank"
                >
                  <i className="fa fa-bed text-white"></i>
                  <span className="tooltip-link">Hotels</span>
                </a>
              </li>
              <li>
                <a
                ...
                >
                  ...
                  <span className="tooltip-link">Car</span>
                </a>
              </li>
              <li className="no-border border-0 umrah-list-item">
                <a
                  ...
                  target="_blank"
                >
                  <i className="umrah-package-icon"></i>
                  <span className="tooltip-link">Umrah Packages</span>
                </a>
              </li>
            </ul>
          </div>
        ...
        <footer className="section page-footer page-footer-minimal bg-default novi-background">
            ...
            <div className="container-fluid reasons-fly_bg">
              <div className="mobile-view-item1">
                <div className="flycard-info">
                  ...
                  <p>
                    Get to where you want to go in style and enjoy an unrivalled
                    travel experience at low-cost. From booking to landing -
                    here's why you should choose flynas.
                  </p>
                  <div className="row card-icon-body">
                    <div className="col-auto card-icon-content aircraft-bg">
                      <i className="card-icon aircraft"></i>
                      <h6>Fleet of 67+ aircraft</h6>
                    </div>
                    <div className="col-auto card-icon-content flights-bg">
                      <i className="card-icon flights"></i>
                      <h6>2000 flights every week</h6>
                    </div>
                    <div className="col-auto card-icon-content passenger-bg">
                      <i className="card-icon passenger"></i>
                      <h6>More than 80 million passengers</h6>
                    </div>
                    <div className="col-auto card-icon-content countries-bg">
                      <i className="card-icon countries"></i>
                      <h6>
                        Over 156 routes to 80+ destinations across more than 38
                        countries
                      </h6>
                    </div>
                  </div>
              ...
              <div className="reasons-to-fly_body">
                <div className="reason-item1 item-box desktop-view-item1">
                  <div className="flycard-info">
                    <h4>Reasons to Fly With Us</h4>
                    <p>
                      Get to where you want to go in style and enjoy an
                      unrivalled travel experience at low-cost. From booking to
                      landing - here's why you should choose flynas.
                    </p>
                    <div className="row card-icon-body">
                      <div className="col-auto card-icon-content aircraft-bg">
                        <i className="card-icon aircraft"></i>
                      ...
                      <div className="col-auto card-icon-content countries-bg">
                        <i className="card-icon countries"></i>
                        <h6>
                          Over 156 routes to 80+ destinations across more than
                          38 countries.
                        </h6>
                      </div>
                    </div>
                ...
                <div className="reason-item2 item-box">
                  <div className="flycard-img">
                    <img
                      src="./refresh-icon_files/Fly-with-us-1.jpg"
                      alt="Fly-with-us-1"
                      className="img-fluid"
                    />
                    <div className="flycard_overlay"></div>
                    <div className="flycard_content">
                      <a
                        href="https://www.flynas.com/en/lowest-fare-finder"
                        className="fly-btn"
                      >
                        Competitive fares <i className="fly-arrow-icon"></i>
                      </a>
                ...
                <div className="reason-item3 item-box">
                  <div className="flycard-img">
                    <img
                      src="./refresh-icon_files/Fly-with-us-2.jpg"
                      alt="Fly-with-us-1"
                      className="img-fluid"
                    />
                    <div className="flycard_overlay"></div>
                ...
                <div className="reason-item4 item-box">
                  <div className="flycard-img">
                    <img
                      src="./refresh-icon_files/Fly-with-us-3.jpg"
                      alt="Fly-with-us-1"
                      className="img-fluid"
                    />
                    <div className="flycard_overlay"></div>
                ...
                <div className="reason-item5 item-box">
                  <div className="flycard-img">
                    <img
                      src="./refresh-icon_files/Fly-with-us-4.jpg"
                      alt="Fly-with-us-1"
                      className="img-fluid"
                    />
                    <div className="flycard_overlay"></div>
                ...
                <div className="reason-item6 item-box">
                  <div className="flycard-img">
                    <img
                      src="./refresh-icon_files/Fly-with-us-5.jpg"
                      alt="Fly-with-us-1"
                      className="img-fluid"
                    />
                    <div className="flycard_overlay"></div>
                    <div className="flycard_content">
                      <a
                        ...
                        className="fly-btn"
                      >
                        Award-Winning Service <i className="fly-arrow-icon"></i>
                      </a>
                    </div>
                  </div>
                </div>
                <div className="reason-item7 item-box">
                  <div className="flycard-img">
                    <img
                      src="./refresh-icon_files/Fly-with-us-6.jpg"
                      alt="Fly-with-us-1"
                      className="img-fluid"
                    />
                    <div className="flycard_overlay"></div>
                    <div className="flycard_content">
                      <a
                        ...
                        className="fly-btn"
                      >
                        nasmiles <i className="fly-arrow-icon"></i>
                      </a>
                    </div>
                  </div>
                </div>
                <div className="reason-item8 item-box">
                  <div className="flycard-img">
                    <img
                      src="./refresh-icon_files/Fly-with-us-7.jpg"
                      alt="Fly-with-us-1"
                      className="img-fluid"
                    />
                    <div className="flycard_overlay"></div>
                    <div className="flycard_content">
                      <a
                        href="https://www.flynas.com/en/more-comfort-space"
                        className="fly-btn"
                      >
                        {" "}
                        Comfort &amp; Privileges
                ...
                <div className="reason-item9 item-box">
                  <div className="flycard-img">
                    <img
                      src="./refresh-icon_files/Fly-with-us-8.jpg"
                      alt="Fly-with-us-1"
                      className="img-fluid"
                    />
                    <div className="flycard_overlay"></div>
                    <div className="flycard_content">
                      <a
                        href="https://booking.nasholidays.com/en/"
                        className="fly-btn"
                      >
                        {" "}
                        nasholidays <i className="fly-arrow-icon"></i>
                      </a>
                    </div>
                  </div>
                </div>
            ...
            <div className="modal-dialog modal-lg">
              <div className="modal-content">
                ...
                <div className="modal-body">
                  <form
                    className="g-2 needs-validation"
                    novalidate=""
                    id="formSubscribeNewsletter"
                  >
                    <p className="mb-lg-2 mb-3">
                      To be the first to find out our latest news and exclusive
                      discounts.
                    </p>
                    ...
                    <div className="row mb-3 gy-2">
                      <div className="col-md-4">
                        <div className="form-floating has-validation text-left rounded-2">
                          ...
                          <label htmlFor="ddlResidenceCountry">
                            City Of Residence*
                          </label>
                          <div className="invalid-feedback">
                      ...
                      <div className="col-md-4">
                        <div className="form-floating has-validation text-left subscribe-newsletter-dob">
                          <input
                            type="text"
                            className="form-control"
                            id="txtDateOfBirth"
                          ...
                          <div className="daterangepicker ltr auto-apply single opensright">
                            <span className="close-city-popup mobile-only">
                              <i className="fa fa-close"></i>
                            </span>
                            <div
                              className="hijri-dates mt-lg-0 pb-lg-0 mt-5"
                              tabIndex="0"
                            >
                              <div className="hijri">
                            ...
                            <div
                              className="drp-calendar left single"
                              style={{ display: "block" }}
                            >
                    ...
                    <div className="row mb-3">
                      <div className="col-md-12 position-relative">
                        <div
                          ...
                          data-sitekey="6Lfq4dUiAAAAALovF8hu3tWn2XEF7ZF5G2rdhdso"
                          id="pnlCaptcha"
                          required=""
                        >
                  ...
                  >
                    ...
                    <p className="mb-5 " style={{ fontSize: "16px" }}>
                      We've sent an activation link to your e-mail address.
                      Remember to activate your account within the next 72
                      hours, before the link expires.
                    </p>
                  </div>
                  <div
                    className="warning-message text-center"
                    id="div-snl-info-message"
                    style={{ display: "none" }}
                  >
                    <p
                      className="mb-5"
                      id="p-snl-info-message"
                      style={{ fontSize: "16px" }}
                    ></p>
                    <button
                      type="button"
          ...
          <div className="footer-info-links-section">
            <div className="p-4">
              <div
                id="footerAccordion"
                className="accordion justify-content-between"
              >
                <div className="accordion-item">
                  <button
                  ...
                  >
                    <div className="accordion-body">
                      <ul className="list-unstyled">
                        ...
                        <li>
                          <a href="https://sp.booking.com/index.html?aid=922212&amp;label=fn-home-navdrop&amp;lang=en&amp;selected_currency=SAR">
                            Book a hotel
                          </a>
                        </li>
                        <li>
                ...
                <div className="accordion-item">
                  ...
                  >
                    <div className="accordion-body">
                      <ul className="list-unstyled">
                        <li>
                          <a href="https://www.flynas.com/en/flights-to-dubai">
                            Flights to Dubai
                          </a>
                        </li>
                        <li>
                          <a href="https://www.flynas.com/en/flights-to-kuwait">
                            Flights to Kuwait
                          </a>
                        </li>
                        <li>
                          <a href="https://www.flynas.com/en/flights-to-islamabad">
                        ...
                        <li>
                          <a href="https://www.flynas.com/en/flights-to-cairo">
                            Flights to Cairo
                          </a>
                        </li>
                        <li>
                          <a href="https://www.flynas.com/en/flights-to-amman">
                            Flights to Amman
                          </a>
                        </li>
                      </ul>
                ...
                <div className="accordion-item">
                  ...
                  >
                    <div className="accordion-body">
                      <ul className="list-unstyled">
                        <li>
                          <a href="https://www.flynas.com/en/flights-to-india">
                            Flights to India
                          </a>
                        </li>
                        <li>
                          <a href="https://www.flynas.com/en/flights-to-georgia">
                            Flights to Georgia
                          </a>
                        </li>
                        <li>
                          <a href="https://www.flynas.com/en/flights-to-jordan">
                            Flights to Jordan
                          </a>
                        </li>
                        <li>
                          <a href="https://www.flynas.com/en/flights-to-egypt">
                            Flights to Egypt
                          </a>
                        </li>
                        <li>
                          <a href="https://www.flynas.com/en/flights-to-saudi-arabia">
                            Flights to Saudi Arabia
                          </a>
                        </li>
                        <li>
                          <a href="https://www.flynas.com/en/flights-to-uae">
                  ...
                  >
                    <div className="accordion-body">
                      <ul className="list-unstyled">
                        ...
                        <li>
                          <a href="https://www.flynas.com/en/plan-my-trip/visa">
                            Visa Requirements To KSA
                          </a>
                        </li>
                        <li>
                          <a href="https://www.flynas.com/en/plan-my-trip/airports-terminals">
                            Airports &amp; Terminals
                          </a>
                        </li>
                        <li>
                          <a href="https://www.flynas.com/en/contact-us/call-center-csu">
                            Help &amp; Support
                          </a>
                        </li>
                        <li>
                          <a
                            href="https://static.flynas.com/media/wfderxmj/integrated-management-system-policy.pdf"
                            target="_blank"
                        ...
                        <li>
                          <a href="https://www.flynas.com/en/blog">Blog</a>
                        </li>
                      </ul>
                    </div>
                  </div>
                ...
                <div className="accordion-item">
                  ...
                  >
                    <div className="accordion-body">
                      <ul className="list-unstyled">
                        <li>
                          <a href="https://help.flynas.com/en/support/refund-request">
                            Request refund
                          </a>
                        </li>
                        <li>
                          <a href="https://help.flynas.com/en/support/payment-issue">
                            Payment problem
                          </a>
                        </li>
                        <li>
                          <a href="https://help.flynas.com/en/complaint-feedback">
                            Feedback
                          </a>
                        </li>
                        <li>
                          <a href="https://help.flynas.com/en/baggage-services/baggage-compensation">
                            Track your Bag
                          </a>
                        </li>
                        <li>
                          <a href="https://help.flynas.com/en/voucher/details">
                            Check your voucher
                          </a>
                        </li>
                        <li>
                          <a href="https://gaca.gov.sa/en/">GACA</a>
                        </li>
                        <li>
                          <a href="https://help.flynas.com/en/support">Help</a>
                        </li>
                        <li>
            ...
            <div className="row">
              <div className="col-md-3">
                <div className="promotions-info-section">
                  <h4 className="promotions-info-title">
                    Flynas App – Your Journey, Your Way
                  </h4>
                  <p className="promotions-info-description">
                    Manage your trips anytime, anywhere.
                  </p>
                </div>
                <div className="row">
                  <div className="col-md-4">
                    ...
                    >
                      <img
                        alt="qrcode"
                        src="./refresh-icon_files/prod-qrcode.png"
                      />
                    </div>
                  </div>
              ...
              <div className="col-md-3">
                <div className="promotions-info-section">
                  ...
                  <p className="promotions-info-description">
                    Get the latest news, travel deals, and support when you need
                    it.
                  </p>
                </div>
                <div className="social-media-links">
                  <a
                    rel="noopener"
                    href="https://www.facebook.com/flynas/"
                    target="_blank"
                  >
                  ...
                  <a
                    rel="noopener"
                    href="https://www.instagram.com/flynas/"
                    target="_blank"
                  >
                  ...
                  <a
                    rel="noopener"
                    href="https://www.tiktok.com/@flynas"
                    target="_blank"
                  >
              ...
              <div className="col-md-3">
                ...
                <div className="awards-section">
                  <img
                    alt=""
                    src="./refresh-icon_files/apex-logo-200x200.png"
                    width="82"
                    height="100"
                    loading="lazy"
                  />
                  <img
                    alt=""
                    src="./refresh-icon_files/skyt_airline-winner_2025.png"
                    width="85"
                    height="100"
                    loading="lazy"
                  />
                  <img
                    alt=""
                    src="./refresh-icon_files/wta.png"
                    width="95"
                    height="100"
                    loading="lazy"
                  />
              ...
              <div className="col-md-3">
                ...
                <div className="payments-section">
                  <img
                    alt="payments"
                    src="./refresh-icon_files/payments-image-en.png"
                  />
                </div>
              </div>
            </div>
            ...
            <div className="px-4">
              <div className="row bottom-footer" style={{ lineHeight: "15px" }}>
                <div className="col-md-4 col-sm-12">
                  Copyright © 2026 flynas. All rights reserved.{" "}
                  <span style={{ fontSize: "9px", display: "block" }}>
                    Site optimized for viewing in Firefox 29+, IE 10+, Safari
                    7+, and Chrome 35+
                  </span>
                </div>
                <div className="col-md-8 col-sm-12">
                  <ul style={{ paddingTop: "5px", textAlign: "right" }}>
                    ...
                    <li>
                      <a href="https://www.flynas.com/en/personal-data-privacy-policy">
                        Personal Data Privacy Policy |{" "}
                      </a>
                    </li>
                    <li>
                      <a href="https://www.flynas.com/en/privacy-policy">
                        Privacy Policy |
                      </a>
                    </li>
                    <li>
                      <a href="https://www.flynas.com/en/cookie-policy">
                        Cookie Policy |
                      </a>
                    </li>
                    <li>
                    ...
                    <li>
                      <a href="https://www.flynas.com/en/sitemap">Site Map</a>
                    </li>
                  </ul>
                </div>
              </div>
      ...
      />
      <img
        src="./refresh-icon_files/adsct(1)"
        height="1"
        width="1"
        fetchPriority="high"
        style={{ display: "none" }}
      ...
      <img
        src="./refresh-icon_files/adsct(2)"
        height="1"
        width="1"
        fetchPriority="high"
        style={{ display: "none" }}
      />
      <img
        src="./refresh-icon_files/adsct(3)"
        height="1"
        width="1"
        fetchPriority="high"
        style={{ display: "none" }}
      ...
      <div data-test-dir="found" data-language="en" dir="ltr">
            ...
            <div>
              ...
              >
                <div className="chat-header" data-testid="chatbot-header">
                  <div className="header-left">
                    <i
                      ...
                      data-testid="chatbot-header-logo"
                    ></i>
                  ...
                  <div className="header-actions">
                    ...
                    <button
                      type="button"
                      className="icon-button "
                      data-testid="header-end-chat-button"
                      aria-label="End Chat"
                    >
                    ...
                    <div>
                      <section className="category-section">
                        <div className="category-header mb2">
                          <div className="gradient-line gradient-line-prev"></div>
                          <span className="category-title uppercase">
                            About Booking
                          </span>
                        ...
                        <div className="tiles-container">
                          <div className="tiles-wrapper">
                            <button className="blank-btn tiles-card ">
                              <div className="tiles-icon">
                                <i className="plane-icon"></i>
                              </div>
                              <p className="tiles-title capitalize">
                                Check flight status
                              </p>
                            </button>
                            <button className="blank-btn tiles-card ">
                ...
                <div
                  ...
                  data-testid="chatbot-message-area"
                >
                  <div className="chat-scroll-container">
                    <div className="chat-message bot-message">
                      <div className="avatar avt-logo">
                        <i
                          className="header-logo-icon"
                            ...
                            <div className="bot-bubble">
                              <div className="bubble-content">
                                <div className="chat-message-text " dir="auto">
                                  <p dir="auto" node="[object Object]">
                                    Good day! This is Flynas AI, your travel
                                    assistant. Need help with a flight or
                                    booking?
                                  </p>
                                </div>
                              </div>
                    ...
                    <div className="chat-message user-message animated-bot-response">
                      <div className="user-bubble">
                        <div className="bubble-content">
                          <p className="chat-message-text pre-wrap" dir="auto">
                            dsdsd
                          </p>
                        </div>
                        <span
                          className="chat-time"
                          data-testid="user-chat-time"
                        >
                          11:03 AM
                        </span>
                      </div>
                          ...
                          <div className="mt8">
                            <div className="bot-bubble">
                              <div className="bubble-content">
                                <div className="chat-message-text " dir="auto">
                                  <p dir="auto" node="[object Object]">
                                    I'm sorry, I couldn't understand your
                                    request. If you need assistance with flynas
                                    travel services, please let me know how I
                                    can help!
                                  </p>
                                </div>
                              </div>
                            ...
                            <div className="bot-bubble">
                              <div className="bubble-content">
                                <div className="chat-message-text " dir="auto">
                                  <p dir="auto" node="[object Object]">
                                    I'm sorry, I couldn't understand your
                                    message. If you need help with flynas travel
                ...
                <div className="chat-input-wrapper ">
                  <div
                    ...
                    data-testid="chatbot-input-area"
                  >
                      ...
                      <div className="text-editor">
                        <div className="editable-content">
                          <div
                            ...
                            data-placeholder="Chat with Flynas"
                    ...
                    <div className="chat-actions">
                      <div className="right-icons">
                        <div className="send-mic-wrapper">
                          <button
                            className="send-mic-btn disabled"
      ...
      <div id="_trackers-67804329">
        <div>
          <div id="tag-79208925"></div>
        </div>
        <div>
          <div id="tag-84067096"></div>
        </div>
        <div>
          <div id="tag-84068464"></div>
        </div>
      </div>
      <div className="daterangepicker ltr auto-apply show-calendar opensleft">
        ...
        <div className="hijri-dates mt-lg-0 pb-lg-0 mt-5" tabIndex="0">
          <div className="hijri">
            ...
            <span className="toggle-text" id="hijricalenderlbl">
              Hijri Calendar
            </span>
          </div>
        </div>
      ...
      <img
        ...
        width="1"
        style={{ display: "none" }}
        src="./refresh-icon_files/src=5415738"
      />
      <webengagedata>
        <div id="webklipper-publisher-widget-container">
          <div id="webengage-notification-inbox-container">
            <template shadowrootmode="open">
              <div></div>
            </template>
          </div>
      ...
      <img
        className="ywa-10000"
        src="./refresh-icon_files/sp.pl.download"
        alt="dot image pixel"
        style={{ display: "none" }}
      />
      <div
        id="batBeacon996394855655"
        style={{
          width: "0px",
          height: "0px",
          display: "none",
      ...
      >
        <img
          id="batBeacon363904952551"
          width="0"
          height="0"
          alt=""
          src="./refresh-icon_files/0"
          style={{
            width: "0px",
            height: "0px",
            display: "none",
      ...
      <img
        ...
        height="1"
        alt=""
        src="./refresh-icon_files/src=13668875"
      />
      <img
        style={{ display: "block", marginTop: "-1px" }}
        className="crpb"
        ...
        height="1"
        alt=""
        src="./refresh-icon_files/src=13668875(1)"
      />
      <div
        style={{
      ...
      <img
        src="./refresh-icon_files/adsct(4)"
        height="1"
        width="1"
        fetchPriority="high"
        style={{ display: "none" }}
      />
      <img
        src="./refresh-icon_files/adsct(5)"
        height="1"
        width="1"
        fetchPriority="high"
        style={{ display: "none" }}
      ...
      <div>
        <div dir="ltr" id="CookiebotWidget" lang="en">
          <button
            className="CookiebotWidget-logo"
            aria-label="Open cookie settings widget"
            lang="en"
          >
            {/* svg omitted */}
          </button>
